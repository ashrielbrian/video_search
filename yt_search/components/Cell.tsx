    ...
    return (
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mt-2 transition-transform duration-500 transform hover:-translate-y-1 hover:scale-102 flex min-h-250">
            <div className="flex flex-col flex-grow">
                ...
                {video.thumbnail && <Image src={video.thumbnail} alt="Placeholder image" className="w-full h-64 object-cover rounded-t-lg" height={100} width={100} />}
                ...
                <div className="flex flex-col flex-grow p-4">
                    ...
                    {
                        "content" in video && (<p className="text-gray-700 text-justify">{desc}</p>)
                    }
